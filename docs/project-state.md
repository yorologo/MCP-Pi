...
**Software baseline:** MCP-Pi Gateway 1.3.4
**Development branch:** `develop`
**Latest immutable tag:** `v1.3.4`
**Current work:** post-1.3.4 maintenance; release state is represented by the immutable tag and runtime provenance
